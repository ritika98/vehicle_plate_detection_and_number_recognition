...
def detect_text(opt):
    ...
    if opt.rgb:
        opt.input_channel = 3
    model = Model(opt)
    print('Model input parameters for DeepText', opt.imgH, opt.imgW, opt.num_fiducial, opt.input_channel, opt.output_channel,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--saved_model',default = 'deep_text_weights_ResNetTPS.pth', required=False, help="path to saved_model to evaluation")
    """ Data processing """
